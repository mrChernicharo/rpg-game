...
export enum InventoryItemDescription {
  ...
  GoldenGauntlet = "Gauntlet made of gold, enhancing physical strength.",
  ...
  Godhand = "Handgear infused with godly energy, amplifying physical and magical abilities.",
...
export enum MagicSpellDescription {
  ...
  Protect = "Increases the defense of a single target against physical attacks.",
